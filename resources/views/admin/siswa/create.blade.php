                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select name="jabatan" id="jabatan" 
                                ...
                                @foreach($jabatanOptions as $option)
                                    <option value="{{ $option }}" {{ old('jabatan', $siswa->jabatan ?? '') == $option ? 'selected' : '' }}>{{ $option }}</option>
                                @endforeach
                            </select>
                            @error('jabatan')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <input type="tel" name="no_hp" id="no_hp" value="{{ old('no_hp', $siswa->no_hp ?? '') }}" 
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500"
                                   required>
                            @error('no_hp')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            @if(isset($siswa) && $siswa->foto)
                                <div class="mt-2 flex items-center">
                                    <img src="{{ asset('storage/'.$siswa->foto) }}" alt="Foto siswa" class="h-16 w-16 rounded-full object-cover border-2 border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                    <div>
                        ...
                        <div class="flex rounded-md shadow-sm">
                            ...
                            <input type="text" name="instagram" id="instagram" value="{{ old('instagram', $siswa->instagram ?? '') }}" 
                    ...
                    <div>
                        ...
                        <div class="flex rounded-md shadow-sm">
                            ...
                            <input type="text" name="facebook" id="facebook" value="{{ old('facebook', $siswa->facebook ?? '') }}" 
                                   class="flex-1 min-w-0 block w-full px-3 py-2 rounded-none rounded-r-md border-gray-300 focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        @error('facebook')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
